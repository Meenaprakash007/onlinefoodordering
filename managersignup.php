<html>
  ...
  <head>
    <title> Manager Signup | wowFood' </title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">wowFood'</a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> wowFood' </span></h1>
     <br>
  ...
  <br>
  <p> wowFood@2022| &copy All Rights Reserved </p>
  <br>
  </footer>
</html>